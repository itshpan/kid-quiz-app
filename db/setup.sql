-- Learning Lab — one-time database setup.
-- Paste this whole file into the D1 Console and press Execute.
...
INSERT INTO classes (id, teacher_code, label, created_at)
VALUES ('grade-6-term-1-cu5j', 'grade-6-term-1-teach-hxw3grhy', 'Grade 6 Term 1', datetime('now'));
